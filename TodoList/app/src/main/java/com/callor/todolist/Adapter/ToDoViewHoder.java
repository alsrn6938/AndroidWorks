...
public class ToDoViewHoder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{
    ...
    public void bindCursor(Cursor cursor) {
            ...
            //DB Primary Key memo Field의 TAG에 저장
...
//                .setActionTextColor(Color.RED);
        ...
        //snackbar 에서 view 추출하고
        View snackView = snackbar.getView();
        //추출된  view 의 바탕색을 바꾸어야 스낵바의 바탕색을 바꿀 수 있다.
